							...
							while($fila = mysqli_fetch_row($result2)){
								...
								if($periodo==1){
									...
									if($periodo==2){
										...
										$conexion = conectar();
										$sql = "call insertarError('".$producto."','".$periodo."','".$error."');"; // en este caso es un update xk como es el 2 ya esta creado
										...
										if($result = $conexion->query($sql5)){
											...
											if($result->num_rows >0){
												...
												$conexion = conectar();
												$sql = "call insertarDatosMediaExponencial('".$producto."','".$calcular."',0,'".$periodo."','".$coef."');";
												if($result = $conexion->query($sql)){
													if($result){
